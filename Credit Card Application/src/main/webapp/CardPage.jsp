    ...
    <div class="align1">
        <div class="box">
            <div class="container">
                ...
                <div class="join"><br>
                    <h3> Card SILVER Advantage</h3><br>
                    <ul>
                        <li>Joining fee: ₹499</li>
                        <li>Annual/Renewal Fee: ₹499</li>
                    </ul><br>
                </div>
                <div>
                    <ul>
        ...
        <div class="box">
            <div class="container">
                ...
                <div class="join"><br>
                    ...
                    <ul>
                        <li>Joining fee: ₹2500</li>
                        <li>Annual/Renewal Fee: ₹2500</li>
                    </ul><br>
                </div>
                <div>
                    <ul>
    ...
    <div class="align2">
        <div class="box">
            <div class="container">
                ...
                <div class="join"><br>
                    <h3> Card PLATINUM Advantage</h3><br>
                    <ul>
                        <li>Joining fee: ₹2999</li>
                        <li>Annual/Renewal Fee: ₹2999</li>
                    </ul><br>
                </div>
                <div>
                    <ul>
